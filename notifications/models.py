...
class Notification(models.Model):
    ...
    NOTIFICATION_TYPES = (
        (LIKED, _("À aimé")),
        (COMMENTED, _("À commenté")),
        (FAVORITED, _("À favorise")),
        (ANSWERED, _("À répondu")),
        (ACCEPTED_ANSWER, _("À accepté")),
        (EDITED_ARTICLE, _("À édite")),
        (ALSO_COMMENTED, _("À aussi commenté")),
        (LOGGED_IN, _("S'est connecté(e)")),
        (LOGGED_OUT, _("S'est déconnecté(e)")),
        (VOTED, _("Approuve")),
        (SHARED, _("À partagé")),
        (SIGNUP, _("S'est inscrit(e)")),
        (REPLY, _("À répondu")),
    )
